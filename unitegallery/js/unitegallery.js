		...
		g_arrItems = [];
		 ...
		 for(var i=0;i<arrChildren.length;i++){
			 ...
			 if(tagname == "img"){
			 	...
			 	objItem.urlThumb = objChild.children('img').attr("src");
				 objItem.title = objChild.children('img').attr("alt");
				 objItem.objThumbImage = objChild.children('img');
